  ...
  <div ref="userActions" class="">
    <div @click="hideActions = !hideActions">
      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke-width="1.5"
           stroke="currentColor" class="w-6 h-6 text-gold hover:dark:text-amber-500 hover:text-amber-500">
    ...
    <ul :class="[{ 'hidden': hideActions }]"
      ...
      <li v-if="!isLoggedIn">
        <NuxtLink class="dropdown-item text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-amber-700 hover:bg-amber-200"
